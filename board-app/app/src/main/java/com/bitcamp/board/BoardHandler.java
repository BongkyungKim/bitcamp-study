...
public class BoardHandler {
  ...
  //Board 인스터스의 주소를 저장할 래퍼런스 배열을 만든다.
  ...
  static void processList() {
    ...
    for (int i = 0; i < boardCount; i++) {
      ...
      // 밀리초 데이터 ==> Data 도구함으로 날짜 정보를 설정
      java.util.Date date = new java.util.Date(boards[i].createdDate);

      // 날짜 정보 ==> "yyyy-MM-dd" 형식의 문자열로 
  ...
  static void processDelete() {
    ...
    // 게시글 개수를 1개 줄이고 맨 마지막 래퍼런스는 null로 비운다.
