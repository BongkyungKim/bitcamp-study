...
public class BoardHandler {
  ...
  public void list(Map<String, String> paraMap, PrintWriter out) throws Exception {
  ...
  public void detail(Map<String, String> paraMap, PrintWriter out) throws Exception {
    ...
    int boardNo = Integer.parseInt(paraMap.get("no"));
  ...
  public void delete(Map<String, String> paraMap, PrintWriter out) throws Exception {
    ...
    int no = Integer.parseInt(paraMap.get("no"));
  ...
  public void update(Map<String, String> paraMap, PrintWriter out) throws Exception {
    ...
    Board board = new Board();
    board.no = Integer.parseInt(paraMap.get("no"));
    board.title = paraMap.get("title");
    board.content = paraMap.get("content");
