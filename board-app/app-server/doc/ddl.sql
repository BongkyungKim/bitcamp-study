...
CREATE TABLE `party` (
  ...
  `mno`      INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
  `p_meal`   VARCHAR(50)  NOT NULL COMMENT '모임시간대', -- 모임시간대
  ...
  `p_gender` VARCHAR(10)  NOT NULL COMMENT '성별', -- 성별
...
CREATE TABLE `event` (
  ...
  `e_gender` VARCHAR(10)  NULL     COMMENT '성별', -- 성별
...
CREATE TABLE `rv_file` (
  ...
  `t_no`        INTEGER      NOT NULL COMMENT '입장권구매번호', -- 입장권구매번호
  `rv_filename` VARCHAR(200) NOT NULL COMMENT '첨부파일명', -- 첨부파일명
  `rv_path`     VARCHAR(200) NOT NULL COMMENT '파일경로', -- 파일경로
  `rv_savename` VARCHAR(200) NOT NULL COMMENT '저장파일명' -- 저장파일명
)
COMMENT '리뷰이미지';
...
CREATE TABLE `feed_file` (
  `f_fileno`   INTEGER      NOT NULL COMMENT '첨부파일 번호', -- 첨부파일 번호
  `f_no`       INTEGER      NOT NULL COMMENT '피드번호', -- 피드번호
  `f_filename` VARCHAR(200) NOT NULL COMMENT '첨부파일명', -- 첨부파일명
  `f_path`     VARCHAR(200) NOT NULL COMMENT '파일 경로', -- 파일 경로
  `f_savename` VARCHAR(200) NOT NULL COMMENT '저장파일명' -- 저장파일명
)
COMMENT '피드 첨부파일';
...
CREATE TABLE `party_file` (
  `p_fileno`   INTEGER      NOT NULL COMMENT '첨부파일 번호', -- 첨부파일 번호
  `p_no`       INTEGER      NOT NULL COMMENT '파티원모집번호', -- 파티원모집번호
  `p_filename` VARCHAR(200) NOT NULL COMMENT '첨부파일명', -- 첨부파일명
  `p_path`     VARCHAR(200) NOT NULL COMMENT '파일 경로', -- 파일 경로
  `p_savename` VARCHAR(200) NOT NULL COMMENT '저장파일명' -- 저장파일명
)
COMMENT '파티게시판 첨부파일';
